...
const Cards=()=> {
  return (
    <div
    className={`card-container shadow-lg max-w-lg min-w-lg rounded-b-md rounded-t-md scrollBg transform rotate-12`}
  >
    <div className="top-text p-8">
      <div className="icon-quotes">
        <svg width="45" height="36" className="mb-5 fill-current text-green-300">
